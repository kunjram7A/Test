...
export default async function AccommodationsPage() {
  const accommodationListings = await getListings('accommodations');
        ...
        <div className="mb-6 bg-card p-4 rounded-lg border">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="relative">
              ...
              <Input placeholder="Search accommodations..." className="pl-10" />
            </div>
            <Select>
              <SelectTrigger>
            ...
            <Card key={listing.id} className="overflow-hidden hover:shadow-lg transition-shadow duration-300">
              ...
              <CardContent className="p-4">
                ...
                <CardDescription className="flex gap-2">
                    ...
                    {listing.gender && <Badge variant="secondary">{listing.gender}</Badge>}
                </CardDescription>
              </CardContent>
